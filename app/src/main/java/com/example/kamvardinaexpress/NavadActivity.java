...
public class NavadActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_navad);
        ...
        if (Build.VERSION.SDK_INT >= 19) {
            ...
            if (!DetectConnection.checkInternetConnection(this)) {
                ...
                webViewsite = findViewById(R.id.navad_webview);
                ...
                webViewsite.loadUrl("https://90tv.ir/");
            }
    ...
    private class CustomWebViewClient extends WebViewClient {
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
            if (!DetectConnection.checkInternetConnection(NavadActivity.this)) {
                Toast.makeText(getApplicationContext(), "No Internet!", Toast.LENGTH_SHORT).show();
            } else {
                view.loadUrl(url);
            }
