...
public class TabnakActivity extends AppCompatActivity {
    WebView webViewsite;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tabnak);
        ...
        if (Build.VERSION.SDK_INT >= 19) {
            ...
            if (!DetectConnection.checkInternetConnection(this)) {
                ...
                webViewsite = findViewById(R.id.tabnak_site);
                ...
                webViewsite.loadUrl("http://www.tabnak.ir");
            }
...
// Function to load all URLs in same webview
    ...
    private class CustomWebViewClient extends WebViewClient {
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
            if (!DetectConnection.checkInternetConnection(TabnakActivity.this)) {
                Toast.makeText(getApplicationContext(), "No Internet!", Toast.LENGTH_SHORT).show();
            } else {
                view.loadUrl(url);
            }
