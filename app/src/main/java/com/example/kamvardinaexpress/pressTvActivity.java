...
public class pressTvActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= 19) {
            ...
            if (!DetectConnection.checkInternetConnection(this)) {
                ...
                webViewsite = findViewById(R.id.presstv_webView);
                ...
                webViewsite.loadUrl("https://www.presstv.com/");
            }
    ...
    private class CustomWebViewClient extends WebViewClient {
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
            if (!DetectConnection.checkInternetConnection(pressTvActivity.this)) {
                Toast.makeText(getApplicationContext(), "No Internet!", Toast.LENGTH_SHORT).show();
            } else {
                view.loadUrl(url);
            }
