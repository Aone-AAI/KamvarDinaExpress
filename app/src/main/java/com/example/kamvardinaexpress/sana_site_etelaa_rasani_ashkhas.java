...
public class sana_site_etelaa_rasani_ashkhas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= 19) {
            ...
            if (!DetectConnection.checkInternetConnection(this)) {
                ...
                webViewsite = findViewById(R.id.sana_site);
                ...
                webViewsite.loadUrl("http://resultcase.adliran.ir/Login/Authenticate?returnUrl=ResultCase/CaseListForPerson&systemName=ResultCaseService&loginType=1&isSelectNaturalPerson=false&isSelectLegalPerson=false&isSelectJudPerson=false&messageUrl=&loginTitle=%d8%b3%d8%a7%d9%85%d8%a7%d9%86%d9%87%20%d8%a7%d8%b7%d9%84%d8%a7%d8%b9%20%d8%b1%d8%b3%d8%a7%d9%86%db%8c%20%d9%be%d8%b1%d9%88%d9%86%d8%af%d9%87%20%d8%a7%d8%b4%d8%ae%d8%a7%d8%b5");
            }
    ...
    private class CustomWebViewClient extends WebViewClient {
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
            if (!DetectConnection.checkInternetConnection(sana_site_etelaa_rasani_ashkhas.this)) {
                Toast.makeText(getApplicationContext(), "No Internet!", Toast.LENGTH_SHORT).show();
            } else {
                view.loadUrl(url);
            }
