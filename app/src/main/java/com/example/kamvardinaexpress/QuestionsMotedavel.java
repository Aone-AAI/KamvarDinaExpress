...
public class QuestionsMotedavel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_questions_motedavel);
        ...
        if (Build.VERSION.SDK_INT >= 19) {
            ...
            if (!DetectConnection.checkInternetConnection(this)) {
                ...
                webViewsite = findViewById(R.id.questionsmotedavel);
                ...
                webViewsite.loadUrl("http://www.adliran.ir/Home/FAQ");
    ...
    private class CustomWebViewClient extends WebViewClient {
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
            if (!DetectConnection.checkInternetConnection(QuestionsMotedavel.this)) {
                Toast.makeText(getApplicationContext(), "No Internet!", Toast.LENGTH_SHORT).show();
            } else {
                view.loadUrl(url);
            }
